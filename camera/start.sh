...
docker run --name gratbot_camera --rm -v $myapp:/app -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=$IP:0 -p 5000:5000 -p 8888:8888 --device=/dev/input/js0 -v /sys/class/leds/xpad0/brightness:/sys/class/leds/xpad0/brightness  -it  grat_opencv:latest /bin/bash

...
from gyrii.NeckGazeGyrus import  NeckPointingErrorCorrectionGyrus,BodyPointingErrorCorrectionGyrus
...
keys_to_send=["rotation_vector",
              ...
              "microphone_data",
              "motor_report"]
gyrii.append(SocketGyrusLink(broker,network_server.input_queue,network_server.output_queue,keys=keys_to_send))
...
gyrii.append(SpeedTestGyrus(broker))

#modified from https://github.com/1988kramer/intel_dataset/blob/master/scripts/Align2D.py
import numpy as np
...
class Align2D:
    ...
    def __init__(self, source_points, target_points, initial_T, max_iter=20,max_delta=1e-4):
        ...
        self.delta_err = 0
        self.num_iter = 0
        self.transform = self.AlignICP(max_iter, max_delta)
    ...
    def AlignICP(self, max_iter, min_delta_err):
        ...
        while delta_err > min_delta_err and num_iter < max_iter:
            ...
            num_iter += 1
        self.mean_sq_error=mean_sq_error

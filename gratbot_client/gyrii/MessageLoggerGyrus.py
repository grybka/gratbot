...
class MessageLoggerGyrus(ThreadedGyrus):
    ...
    def get_keys(self):
        return [ "latest_pose","pose_measurement","pose_offset","drive/motors_active","notification","velocity_measurement","pose_certainty_lost","motor_command","video_offset","visual_tracker_objects","tagged_objects","position_sensor/gyro" ]
